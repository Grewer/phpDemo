...
<head>
    <title><?php echo ($data["nickName"]); ?> - 知乎</title>
...
<div class="container" style="display: none">
    ...
    <main class="App-main">
                    ...
                    <div class="Card">
                        ...
                        <div class="ProfileHeader-wrapper">
                            <div class="ProfileHeader-main">
                                <div class="UserAvatarEditor ProfileHeader-avatar" style="top: -25px;" @mouseover="over()" @mouseout="out()" @click="photo">
                                ...
                                <div class="ProfileHeader-content">
                                    <div class="ProfileHeader-contentHead">
                                        <h1 class="ProfileHeader-title"><span class="ProfileHeader-name"><?php echo ($data["nickName"]); ?>
                                        </span><span class="RichText ProfileHeader-headline"><?php echo ($data["autograph"]); ?></span><!-- 一句话简介 --></h1>
                                    </div>
                                    ...
                                    <title></title>
                                    <g><path d="M15 3.998v-2C14.86.89 13.98 0 13 0H7C5.822 0 5.016.89 5 2v2l-3.02-.002c-1.098 0-1.97.89-1.97 2L0 16c0 1.11.882 2 1.98 2h16.033c1.1 0 1.98-.89 1.987-2V6c-.007-1.113-.884-2.002-1.982-2.002H15zM7 4V2.5s-.004-.5.5-.5h5c.5 0 .5.5.5.5V4H7z"></path></g></svg></div><!-- react-text: 103 --><?php echo ($data["position"]); ?>
                                    <!-- 职位 --></div>
                                    ...
                                    <div class="ProfileHeader-detailItem"><span class="ProfileHeader-detailLabel">学校</span>
                                        <div class="ProfileHeader-detailValue"><span><?php echo ($data["school"]); ?>·<?php echo ($data["major"]); ?>
                                        </span></div>
                                    </div>
                                    <div class="ProfileHeader-detailItem"><span class="ProfileHeader-detailLabel">所在公司</span>
                                        <div class="ProfileHeader-detailValue"><?php echo ($data["company"]); ?>·<?php echo ($data["position"]); ?>
                                        </div>
                                    </div>
                                    <div class="ProfileHeader-detailItem"><span class="ProfileHeader-detailLabel">个人简介</span>
                                        <div class="RichText ProfileHeader-detailValue"><?php echo ($data["introduce"]); ?>
                                        </div>
                                    </div>
                                </div>
                                </span>
                            ...
                            <div class="ProfileHeader-contentFooter">
                                ...
                                <div class="ProfileButtonGroup ProfileHeader-buttons">
                                    <a href="<?php echo U('/index.php/People/edit');?>">
                                        <button class="Button Button--blue" type="button">
                                            编辑
                                            个人
                                            资料
                ...
                <div class="Card ProfileMain" id="ProfileMain">
                    <div class="ProfileMain-header">
                        <ul role="tablist" class="Tabs ProfileMain-tabs">
                            ...
                            <li role="tab" class="Tabs-item" aria-controls="Profile-answers">
                                <a class="Tabs-link is-active"  href="/index.php/People">
                                    回答
                                    <span class="Tabs-meta"><?php echo ($ansnum); ?></span></a>
                            </li>
                           
                            <li role="tab" class="Tabs-item" aria-controls="Profile-asks">
                                <a class="Tabs-link" href="/index.php/People/index/type/ques">
                                    提问
                                    <span class="Tabs-meta"><?php echo ($quesnum); ?></span></a>
                            </li>
                            
                            <li role="tab" class="Tabs-item Tabs-item--noMeta" aria-controls="Profile-following"><a class="Tabs-link" href="/index.php/People/index/type/atten">关注</a></li>
                        </ul>
                    </div>
                    <div>
                        <div>
                            ...
                            <component v-bind:is="type" v-for="(item, index) in list" v-bind:item="item">
                                ...
                                <div class="ContentItem-meta">
                                    <div class="AnswerItem-meta">
                                        <div class="AuthorInfo"><span class="UserLink AuthorInfo-avatarWrapper"><div class="Popover"><div id="Popover-73986-83444-toggle" aria-haspopup="true" aria-expanded="false" aria-owns="Popover-73986-83444-content"><a href="/index.php/people/person/personid/<?php echo ($data["id"]); ?>" class="UserLink-link"><img width="38" height="38" src="<?php echo ($data["photo"]); ?>"  class="Avatar AuthorInfo-avatar"></a></div></div></span>
                                        <div class="AuthorInfo-content">
                                            <div class="AuthorInfo-title">
                                            <div class="AuthorInfo-name"><span class="UserLink"><div class="Popover"><div id="Popover-73988-42102-toggle" aria-haspopup="true" aria-expanded="false" aria-owns="Popover-73988-42102-content"><a href="/index.php/people/person/personid/<?php echo ($data["id"]); ?>" class="UserLink-link"><?php echo ($data["nickName"]); ?></a></div></div></span></div>
                                            </div>
                                            <div class="RichText AuthorInfo-badge"><?php echo ($data["autograph"]); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="Profile-sideColumn" data-za-module="RightSideBar" style="margin-left: 10px;">
            ...
            <a class="Profile-lightItem" href="/index.php/People/index/type/atten"><span class="Profile-lightItemName">关注的话题</span><span class="Profile-lightItemValue"><?php echo ($attennum); ?></span></a>
        ...
        <div style="display:none" v-show="isshowdel"><div data-reactroot=""><span><div class="Modal-wrapper"><div class="Modal-backdrop"></div><div class="Modal Modal--default" tabindex="0"><div class="Modal-inner"><h3 class="Modal-title">你确定要删除自己的答案吗？</h3><div class="Modal-subtitle">答案内容不会被永久删除，你还可以撤消本次删除操作。</div><div class="Modal-content Modal-content--buttonGroupOnly"><div class="ModalButtonGroup ModalButtonGroup--vertical"><button class="Button Button--primary Button--blue" type="button" @click="del()">确认</button><button @click="hidedel" class="Button" type="button">取消</button></div></div></div><div class="Modal-snackbar Modal-snackbar--collapsed"></div><button @click="hidedel" class="Button Modal-closeButton Button--plain" aria-label="关闭" type="button"><svg viewBox="0 0 14 14" class="Icon Modal-closeIcon Icon--remove" width="16" height="16" aria-hidden="true" style="height: 16px; width: 16px;"><title></title><g><path d="M8.486 7l5.208-5.207c.408-.408.405-1.072-.006-1.483-.413-.413-1.074-.413-1.482-.005L7 5.515 1.793.304C1.385-.103.72-.1.31.31-.103.724-.103 1.385.305 1.793L5.515 7l-5.21 5.207c-.407.408-.404 1.072.007 1.483.413.413 1.074.413 1.482.005L7 8.485l5.207 5.21c.408.407 1.072.404 1.483-.007.413-.413.413-1.074.005-1.482L8.485 7z"></path></g></svg></button></div></div></span></div></div>
    </main>
</body>
